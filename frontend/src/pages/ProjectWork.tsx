      ...
      <div className="glass-card" style={{ padding: 0, overflow: 'hidden', marginBottom: '1.5rem' }}>
        ...
        <div style={{ padding: '1rem 1.25rem' }}>
          <DataTable<EnrichedWBS>
            data={tableData}
            isLoading={loading}
            searchPlaceholder="Search by discipline name, status, dates…"
            exportFilename="project_work_disciplines"
            defaultPageSize={15}
            ...
            <div className="modal-body">
              <form onSubmit={handleSaveAdd} className="flex-col gap-4">
                ...
                <div className="form-group mb-4">
                  ...
                  <input type="number" step="any" min="0" required value={addForm.total_hours} onChange={(e) => setAddForm({ ...addForm, total_hours: Number(e.target.value) })} className="form-input" style={{ borderRadius: '8px' }} />
                </div>
                <div className="form-group mb-4">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form onSubmit={handleSaveEdit} className="flex-col gap-4">
                ...
                <div className="form-group mb-4">
                  <label className="form-label text-xs">Planned Total Hours</label>
                  <input type="number" step="any" min="0" required value={editForm.total_hours} onChange={(e) => setEditForm({ ...editForm, total_hours: Number(e.target.value) })} className="form-input" style={{ borderRadius: '8px' }} />
                </div>
                <div className="form-group mb-4">
                  <label className="form-label text-xs">Planning Notes</label>
